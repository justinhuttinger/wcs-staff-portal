...
export default function ClubHealthReport({ startDate, endDate, locationSlug, canDrill = false, excludedCategories = [] }) {
 ...
 */
function DrillCell({ drill, available = true, canDrill, startDate, endDate, locationSlug, plan, ...cell }) {
