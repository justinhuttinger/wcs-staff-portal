...
export default function MembershipReport({ startDate, endDate, locationSlug }) {
  ...
  if (loading) return <p className="mx-auto w-fit bg-surface text-text-primary text-sm px-4 py-2 my-6 rounded-lg border border-border shadow-sm block">Loading membership data...</p>
