      ...
      <div className="bg-surface/95 backdrop-blur-sm rounded-xl border border-border p-5 mb-6 flex items-center gap-3">
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          <button
            ...
            disabled={refreshing}
            className="flex items-center gap-2 px-4 py-2 text-sm font-bold rounded-lg bg-wcs-red text-white shadow hover:brightness-110 active:translate-y-px transition disabled:opacity-60"
          >
