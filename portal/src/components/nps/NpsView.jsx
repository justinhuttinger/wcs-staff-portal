      ...
      <div className="bg-surface/95 backdrop-blur-sm rounded-xl border border-border p-5 space-y-4">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button onClick={onBack} className="redundant-back px-4 py-2 text-sm font-medium text-text-primary border border-border rounded-lg hover:bg-bg transition-colors">
              Back
            </button>
