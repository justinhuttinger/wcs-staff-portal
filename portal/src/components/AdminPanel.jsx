...
import GroupXAdminView from './groupx/GroupXAdminView'
import FacilityAdminView from './facility/FacilityAdminView'
import ClassSeedingAdmin from './admin/ClassSeedingAdmin'
...
import SaveOffersAdmin from './admin/SaveOffersAdmin'
...
import MemberAppBroadcasts from './admin/memberapp/MemberAppBroadcasts'
...
const SETUP_TILES = [
  ...
  { key: 'appearance', label: 'Appearance', desc: 'Portal Theme', icon: 'M4.098 19.902a3.75 3.75 0 0 0 5.304 0l6.401-6.402M6.75 21A3.75 3.75 0 0 1 3 17.25V4.125C3 3.504 3.504 3 4.125 3h5.25c.621 0 1.125.504 1.125 1.125v4.072M6.75 21a3.75 3.75 0 0 0 3.75-3.75V8.197M6.75 21h13.125c.621 0 1.125-.504 1.125-1.125v-5.25c0-.621-.504-1.125-1.125-1.125h-4.072M10.5 8.197l2.88-2.88c.438-.439 1.15-.439 1.59 0l3.712 3.713c.44.44.44 1.152 0 1.59l-2.879 2.88M6.75 17.25h.008v.008H6.75v-.008Z' },
...
const TECHNICAL_TILES = [
  ...
  { key: 'save-offers', label: 'Save Offers', desc: 'Cancel Flow & Retention Offers', icon: 'M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z' },
  ...
  { key: 'facility-admin', label: 'Courts & Pool', desc: 'Boards & Locations', icon: 'M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5M12 12.75h.008v.008H12v-.008z' },
  { key: 'class-seeding', label: 'Class Seeding', desc: 'Fill Empty Classes', icon: 'M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z' },
]
...
const EXPERIMENTAL_TILES = [
  ...
  { key: 'member-notifications', label: 'App Notifications', desc: 'Send or Schedule to Members (Beta)', icon: 'M14.857 17.082a23.848 23.848 0 0 0 5.454-1.31A8.967 8.967 0 0 1 18 9.75V9A6 6 0 0 0 6 9v.75a8.967 8.967 0 0 1-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 0 1-5.714 0m5.714 0a3 3 0 1 1-5.714 0' },
  { key: 'member-app', label: 'Member App', desc: 'Tiers, Programs and Messages (Beta)', icon: 'M10.5 1.5H8.25A2.25 2.25 0 0 0 6 3.75v16.5a2.25 2.25 0 0 0 2.25 2.25h7.5A2.25 2.25 0 0 0 18 20.25V3.75a2.25 2.25 0 0 0-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3' },
  ...
  if (activeSection) {
    ...
    return (
      <div className="w-full px-8 py-6">
        ...
        {activeSection === 'member-notifications' && <MemberAppBroadcasts />}
        ...
        {activeSection === 'appearance' && <AppearanceAdmin />}
        ...
        {activeSection === 'save-offers' && <SaveOffersAdmin />}
        ...
        {activeSection === 'facility-admin' && <FacilityAdminView />}
