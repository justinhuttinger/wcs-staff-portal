...
export default function DayOneCalendarView({ user, onBack, location }) {
  ...
  return (
    <div className="max-w-3xl mx-auto w-full px-8 py-6">
      ...
      {loading && <p className="loading-card mx-auto block my-6">Loading appointments...</p>}

      {/* Day View */}
      {!loading && view === 'day' && (
        <div className="space-y-3">
          {dayAppointments.length === 0 && (
            <p className="empty-card mx-auto block my-6">No Day One appointments for this day</p>
          )}
