...
export default function TrainerAvailabilityView({ user, onBack, location, isAdmin }) {
  ...
  return (
    <div className="max-w-3xl mx-auto w-full px-8 py-6">
      ...
      {loading && <p className="mx-auto w-fit bg-surface text-text-primary text-sm px-4 py-2 my-6 rounded-lg border border-border shadow-sm block">Loading availability...</p>}
