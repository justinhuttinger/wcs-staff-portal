...
const { syncRecurringServices, syncRecurringServicesForClub, isRsSyncRunning } = require('./abc/recurringServicesSync');
...
//
// Running-lock lives in the sync module itself (isRsSyncRunning), so this
// endpoint AND the scheduler share the same state — neither can start a
